...
const PostCard = ({ title, excerpt, imageUrl, slug, createdAt }: PostCardProps) => {
  return (
    ...
    <Link href={`/post/${slug}`} 
    className="block border rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden hover:scale-105 transition-transform bg-white/80">
